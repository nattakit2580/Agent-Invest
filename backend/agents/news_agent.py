...
class NewsAgent(BaseAgent):
    ...
    def analyze(self, symbol: str, market_data: dict, news: list[dict]) -> dict:
        ...
        system = (
            ...
            "No markdown, no explanation outside JSON. Write all text fields (summary, key_points, major_events) in Thai language. Keep JSON keys, direction values (bullish/bearish/neutral), and numbers in English."
        )
