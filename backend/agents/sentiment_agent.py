...
class SentimentAgent(BaseAgent):
    ...
    def analyze(self, symbol: str, market_data: dict, news: list[dict]) -> dict:
        system = (
            ...
            "No markdown, no explanation outside JSON. Write all text fields (summary, key_points) in Thai language. Keep JSON keys, direction/mood/momentum/crowd_sentiment enum values, and numbers in English."
        )
