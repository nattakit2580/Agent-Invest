...
MODEL_CATALOG = [
    # --- Free tier (no cost, rate-limited). Verified against OpenRouter 2026-07-21.
    #     OpenRouter retires free models often; re-check openrouter.ai/models if 404s appear.
    ...
    {"id": "nvidia/nemotron-3-ultra-550b-a55b:free", "label": "Nemotron 3 Ultra 550B (free)", "tier": "strong", "free": True},
    {"id": "google/gemma-4-31b-it:free", "label": "Gemma 4 31B (free)", "tier": "balanced", "free": True},
    {"id": "google/gemma-4-26b-a4b-it:free", "label": "Gemma 4 26B (free)", "tier": "fast", "free": True},
    {"id": "nvidia/nemotron-nano-9b-v2:free", "label": "Nemotron Nano 9B (free)", "tier": "fast", "free": True},
    # --- Paid tier (needs OpenRouter credit) — for higher quality/reliability. ---
